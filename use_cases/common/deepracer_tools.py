...
# ── Patch library: correct video stream topic ─────────────────────────────────
# Library uses /display_mjpeg; device expects /camera_pkg/display_mjpeg
def _get_raw_video_stream_patched(self):
    self._get_csrf_token()
    video_url = (
        self.URL + "/route?topic=/camera_pkg/display_mjpeg&width=480&height=360"
    )
...
drctl.Client.get_raw_video_stream = _get_raw_video_stream_patched
